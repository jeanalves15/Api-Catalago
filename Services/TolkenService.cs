...
{
    public class TolkenService : ItolkenService
    {
        ...
        public ClaimsPrincipal GetPrincipalFromExpiredToken(string token, IConfiguration _config)
        {
            ...
            var tokenValidionParameters = new TokenValidationParameters
            {
            ...
            var principal=tokenHandler.ValidateToken(token, tokenValidionParameters,
